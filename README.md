...
```
java -Dspring.profiles.active=production -jar ./target/practice-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=com.johanwaluyo.java/practice
```
